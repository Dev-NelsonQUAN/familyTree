...
//   name: "Hosea Leke", // Changed father's name to Hosea
//   type: "father",
//   isExpanded: false, // Initially, the father's section is collapsed
//   wives: [
//     {
//       id: "wife_onere", // Changed wife's ID
//       name: `Esther Leke \n (Nee ebiesuwa)`, // Changed first wife's name to Onere
//       type: "wife",
//       isExpanded: false,
//       children: [
//         { id: "child_onere_john", name: "Bamigbe leke (F) (Married to Akinjile)", type: "child" },
//         { id: "child_onere_mary", name: "Tunji Leke (M) (Late)", type: "child" },
//         { id: "child_onere_peter", name: "Adeoga Leke (M)", type: "child" },
//         { id: "child_onere_jane", name: "Ogo-oluwa Leke (M)", type: "child" },
//         { id: "child_onere_michael", name: "Ire Leke (F)", type: "child" },
//         { id: "child_onere_emily", name: "Aro Leke (F) (Married to Balogun)", type: "child" },
//         { id: "child_onere_daniel", name: "Olametan Leke (F) (Married to Alademehin)", type: "child" },
//         // { id: "child_onere_olivia", name: "Olivia", type: "child" }
//       ]
//     },
//     {
//       id: "wife_luko", // Changed wife's ID
//       name: "Florence Leke (Nee Ikujimbola)", // Changed second wife's name to Luko
//       type: "wife",
//       isExpanded: false,
//       children: [
//         { id: "child_luko_james", name: "Gbenro Leke (M)", type: "child" },
//         { id: "child_luko_sophia", name: "Anu Leke (F)", type: "child" },
//         { id: "child_luko_william", name: "Gbotemi Leke (M)", type: "child" },
//         { id: "child_luko_ava", name: "Kayode Leke (M)", "type": "child" }
//       ]
//     },
//     {
//       id: "wife_mabo", // Changed wife's ID
//       name: "Ibironke Leke", // Changed third wife's name to Mabo
//       type: "wife",
//       isExpanded: false,
//       children: [
//         { id: "child_mabo_joseph", name: "Kosede Leke (M)", type: "child" },
//         { id: "child_mabo_mia", name: "Ayo Leke (F)", type: "child" },
//         { id: "child_mabo_charles", name: "Sunday Leke (Late)", type: "child" },
//         { id: "child_mabo_isabella", name: "Monday Leke (M)", type: "child" },
//         { id: "child_mabo_thomas", name: "Iyabo Leke (F)", type: "child" },
//         { id: "child_mabo_charlotte", name: "Toyin Leke (F)", type: "child" },
